...
from xadmin.util import lookup_field, display_for_field, label_for_field, unquote, boolean_icon, force_str, smart_str
...
class EditablePlugin(BaseAdminPlugin):
    ...
    def init_request(self, *args, **kwargs):
        active = bool(self.request.method == 'GET' and self.admin_view.has_change_permission(self.request) and self.list_editable)
        if active:
